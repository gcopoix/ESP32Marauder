#pragma once
  ...
  //#define MARAUDER_CYD_GUITION_W // ESP32-2432W328C with capacitive touch
  ...
  #elif defined(MARAUDER_CYD_GUITION_W)
    #define HARDWARE_NAME "CYD 2432W328C GUITION"
 ...
 //// BOARD FEATURES
    ...
    #define HAS_GPS
    //#define HAS_CYD_TOUCH
    #define HAS_CAP_TOUCH TOUCH_CYD_24C
  #endif

  #ifdef MARAUDER_CYD_GUITION_W
    #define HAS_TOUCH
    #define HAS_FLIPPER_LED
    //#define FLIPPER_ZERO_HAT
    //#define HAS_BATTERY
  ...
  //// DISPLAY DEFINITIONS
    ...
    #if defined(MARAUDER_CYD_GUITION_W)
      #define CHAN_PER_PAGE 7
  ...
  //// STUPID CYD STUFF
    ...
    #endif
  #endif // defined(HAS_CYD_TOUCH) || defined(HAS_C5_SD) || defined(HAS_SEPARATE_SD)
